## The blockchain's core currency: Gas

### What is the Gas Fee
Gas Fee is a Fee that users pay for every transaction they execute.
The Currency/Token (commonly referenced as just Gas) for this fee is the blockchain's native currency, used for incentivizing Validators.
In Sui, the gas token is the SUI coin.

The formula of the Total Gas Fee of a transaction in Sui is:
...
#### MIST 
Gas on Sui is typically expressed in MIST, the smallest unit of SUI.
...
You can Buy, Transfer, get from Airdrops, use Faucets (for testnet/devnet) and any other way you would usually buy SUI.
